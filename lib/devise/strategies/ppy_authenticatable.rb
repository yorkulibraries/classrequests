## lib/devise/strategies/ppy_authenticatable.rb
    ...
    class PpyAuthenticatable < Base
      ...
      def authenticate!
        ...
        if value_of_credentials
          resource = mapping.to.find_or_create_with_authentication_profile(setup_authentication_profile)
          success!(resource)
        else
          fail(:missing_ppy_credentials)
        end
      end
