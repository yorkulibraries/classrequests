...
#       post departments_url, params: { department: { branch_division: @department.branch_division, name: @department.name } }
#     end
#
...
#     patch department_url(@department), params: { department: { branch_division: @department.branch_division, name: @department.name } }
