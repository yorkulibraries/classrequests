class Staff::Manager::BaseController < ApplicationController
  ...
  def check_access
    # logger.debug "MANAGER BASE = ACCESS: #{@access}"
    ...
    # else
    #   @auth_check = 'Failed, I am in else. I do not have a staff profile'
    #   render(:file => File.join(Rails.root, 'public/403.html'), :status => 403, :layout => false)
    #
    # end
  end
