class Staff::StaffProfilesController < Staff::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @staff_profile.save
        format.html { redirect_to staff_staff_profile_path(@staff_profile), notice: 'Staff profile was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @staff_profile.update(staff_profile_params)
        format.html { redirect_to staff_staff_profile_path(@staff_profile), notice: 'Staff profile was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to operators_index_path, notice: 'Staff profile was successfully destroyed.' }
